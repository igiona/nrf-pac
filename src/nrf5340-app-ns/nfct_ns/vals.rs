...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishAutocolresstartedEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishAutocolresstartedEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishAutocolresstartedEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishAutocolresstartedEn {
    #[inline(always)]
    fn from(val: u8) -> PublishAutocolresstartedEn {
        PublishAutocolresstartedEn::from_bits(val)
    }
}
impl From<PublishAutocolresstartedEn> for u8 {
    #[inline(always)]
    fn from(val: PublishAutocolresstartedEn) -> u8 {
        PublishAutocolresstartedEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishCollisionEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishCollisionEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishCollisionEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishCollisionEn {
    #[inline(always)]
    fn from(val: u8) -> PublishCollisionEn {
        PublishCollisionEn::from_bits(val)
    }
}
impl From<PublishCollisionEn> for u8 {
    #[inline(always)]
    fn from(val: PublishCollisionEn) -> u8 {
        PublishCollisionEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishFielddetectedEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishFielddetectedEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishFielddetectedEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishFielddetectedEn {
    #[inline(always)]
    fn from(val: u8) -> PublishFielddetectedEn {
        PublishFielddetectedEn::from_bits(val)
    }
}
impl From<PublishFielddetectedEn> for u8 {
    #[inline(always)]
    fn from(val: PublishFielddetectedEn) -> u8 {
        PublishFielddetectedEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishFieldlostEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishFieldlostEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishFieldlostEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishFieldlostEn {
    #[inline(always)]
    fn from(val: u8) -> PublishFieldlostEn {
        PublishFieldlostEn::from_bits(val)
    }
}
impl From<PublishFieldlostEn> for u8 {
    #[inline(always)]
    fn from(val: PublishFieldlostEn) -> u8 {
        PublishFieldlostEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishRxerrorEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishRxerrorEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishRxerrorEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishRxerrorEn {
    #[inline(always)]
    fn from(val: u8) -> PublishRxerrorEn {
        PublishRxerrorEn::from_bits(val)
    }
}
impl From<PublishRxerrorEn> for u8 {
    #[inline(always)]
    fn from(val: PublishRxerrorEn) -> u8 {
        PublishRxerrorEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishRxframeendEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishRxframeendEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishRxframeendEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishRxframeendEn {
    #[inline(always)]
    fn from(val: u8) -> PublishRxframeendEn {
        PublishRxframeendEn::from_bits(val)
    }
}
impl From<PublishRxframeendEn> for u8 {
    #[inline(always)]
    fn from(val: PublishRxframeendEn) -> u8 {
        PublishRxframeendEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishRxframestartEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishRxframestartEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishRxframestartEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishRxframestartEn {
    #[inline(always)]
    fn from(val: u8) -> PublishRxframestartEn {
        PublishRxframestartEn::from_bits(val)
    }
}
impl From<PublishRxframestartEn> for u8 {
    #[inline(always)]
    fn from(val: PublishRxframestartEn) -> u8 {
        PublishRxframestartEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishSelectedEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishSelectedEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishSelectedEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishSelectedEn {
    #[inline(always)]
    fn from(val: u8) -> PublishSelectedEn {
        PublishSelectedEn::from_bits(val)
    }
}
impl From<PublishSelectedEn> for u8 {
    #[inline(always)]
    fn from(val: PublishSelectedEn) -> u8 {
        PublishSelectedEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishTxframeendEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishTxframeendEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishTxframeendEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishTxframeendEn {
    #[inline(always)]
    fn from(val: u8) -> PublishTxframeendEn {
        PublishTxframeendEn::from_bits(val)
    }
}
impl From<PublishTxframeendEn> for u8 {
    #[inline(always)]
    fn from(val: PublishTxframeendEn) -> u8 {
        PublishTxframeendEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishTxframestartEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishTxframestartEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishTxframestartEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishTxframestartEn {
    #[inline(always)]
    fn from(val: u8) -> PublishTxframestartEn {
        PublishTxframestartEn::from_bits(val)
    }
}
impl From<PublishTxframestartEn> for u8 {
    #[inline(always)]
    fn from(val: PublishTxframestartEn) -> u8 {
        PublishTxframestartEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeEnablerxdataEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeEnablerxdataEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeEnablerxdataEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeEnablerxdataEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeEnablerxdataEn {
        SubscribeEnablerxdataEn::from_bits(val)
    }
}
impl From<SubscribeEnablerxdataEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeEnablerxdataEn) -> u8 {
        SubscribeEnablerxdataEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeGoidleEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeGoidleEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeGoidleEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeGoidleEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeGoidleEn {
        SubscribeGoidleEn::from_bits(val)
    }
}
impl From<SubscribeGoidleEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeGoidleEn) -> u8 {
        SubscribeGoidleEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeGosleepEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeGosleepEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeGosleepEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeGosleepEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeGosleepEn {
        SubscribeGosleepEn::from_bits(val)
    }
}
impl From<SubscribeGosleepEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeGosleepEn) -> u8 {
        SubscribeGosleepEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeSenseEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeSenseEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeSenseEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeSenseEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeSenseEn {
        SubscribeSenseEn::from_bits(val)
    }
}
impl From<SubscribeSenseEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeSenseEn) -> u8 {
        SubscribeSenseEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
