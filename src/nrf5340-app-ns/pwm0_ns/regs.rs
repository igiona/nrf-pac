...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct PublishLoopsdone(pub u32);
impl PublishLoopsdone {
    #[doc = "DPPI channel that event LOOPSDONE will publish to."]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::PublishLoopsdoneEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::PublishLoopsdoneEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::PublishLoopsdoneEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for PublishLoopsdone {
    #[inline(always)]
    fn default() -> PublishLoopsdone {
        PublishLoopsdone(0)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct PublishPwmperiodend(pub u32);
impl PublishPwmperiodend {
    #[doc = "DPPI channel that event PWMPERIODEND will publish to."]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::PublishPwmperiodendEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::PublishPwmperiodendEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::PublishPwmperiodendEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for PublishPwmperiodend {
    #[inline(always)]
    fn default() -> PublishPwmperiodend {
        PublishPwmperiodend(0)
    }
}
#[doc = "Description collection: Publish configuration for event SEQEND\\[n\\]"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct PublishSeqend(pub u32);
impl PublishSeqend {
    #[doc = "DPPI channel that event SEQEND\\[n\\] will publish to."]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::PublishSeqendEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::PublishSeqendEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::PublishSeqendEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for PublishSeqend {
    #[inline(always)]
    fn default() -> PublishSeqend {
        PublishSeqend(0)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct PublishSeqstarted(pub u32);
impl PublishSeqstarted {
    #[doc = "DPPI channel that event SEQSTARTED\\[n\\] will publish to."]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::PublishSeqstartedEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::PublishSeqstartedEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::PublishSeqstartedEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for PublishSeqstarted {
    #[inline(always)]
    fn default() -> PublishSeqstarted {
        PublishSeqstarted(0)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SubscribeNextstep(pub u32);
impl SubscribeNextstep {
    #[doc = "DPPI channel that task NEXTSTEP will subscribe to"]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::SubscribeNextstepEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::SubscribeNextstepEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::SubscribeNextstepEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for SubscribeNextstep {
    #[inline(always)]
    fn default() -> SubscribeNextstep {
        SubscribeNextstep(0)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SubscribeSeqstart(pub u32);
impl SubscribeSeqstart {
    #[doc = "DPPI channel that task SEQSTART\\[n\\] will subscribe to"]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::SubscribeSeqstartEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::SubscribeSeqstartEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::SubscribeSeqstartEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for SubscribeSeqstart {
    #[inline(always)]
    fn default() -> SubscribeSeqstart {
        SubscribeSeqstart(0)
    }
}
