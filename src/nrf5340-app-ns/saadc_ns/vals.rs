...
impl LimithEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> LimithEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for LimithEn {
    #[inline(always)]
    fn from(val: u8) -> LimithEn {
        LimithEn::from_bits(val)
    }
}
impl From<LimithEn> for u8 {
    #[inline(always)]
    fn from(val: LimithEn) -> u8 {
        LimithEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
impl LimitlEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> LimitlEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for LimitlEn {
    #[inline(always)]
    fn from(val: u8) -> LimitlEn {
        LimitlEn::from_bits(val)
    }
}
impl From<LimitlEn> for u8 {
    #[inline(always)]
    fn from(val: LimitlEn) -> u8 {
        LimitlEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishCalibratedoneEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishCalibratedoneEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishCalibratedoneEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishCalibratedoneEn {
    #[inline(always)]
    fn from(val: u8) -> PublishCalibratedoneEn {
        PublishCalibratedoneEn::from_bits(val)
    }
}
impl From<PublishCalibratedoneEn> for u8 {
    #[inline(always)]
    fn from(val: PublishCalibratedoneEn) -> u8 {
        PublishCalibratedoneEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishResultdoneEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishResultdoneEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishResultdoneEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishResultdoneEn {
    #[inline(always)]
    fn from(val: u8) -> PublishResultdoneEn {
        PublishResultdoneEn::from_bits(val)
    }
}
impl From<PublishResultdoneEn> for u8 {
    #[inline(always)]
    fn from(val: PublishResultdoneEn) -> u8 {
        PublishResultdoneEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeCalibrateoffsetEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeCalibrateoffsetEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeCalibrateoffsetEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeCalibrateoffsetEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeCalibrateoffsetEn {
        SubscribeCalibrateoffsetEn::from_bits(val)
    }
}
impl From<SubscribeCalibrateoffsetEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeCalibrateoffsetEn) -> u8 {
        SubscribeCalibrateoffsetEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeSampleEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeSampleEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeSampleEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeSampleEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeSampleEn {
        SubscribeSampleEn::from_bits(val)
    }
}
impl From<SubscribeSampleEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeSampleEn) -> u8 {
        SubscribeSampleEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
