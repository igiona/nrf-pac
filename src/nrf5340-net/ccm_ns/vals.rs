...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishEndcryptEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishEndcryptEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishEndcryptEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishEndcryptEn {
    #[inline(always)]
    fn from(val: u8) -> PublishEndcryptEn {
        PublishEndcryptEn::from_bits(val)
    }
}
impl From<PublishEndcryptEn> for u8 {
    #[inline(always)]
    fn from(val: PublishEndcryptEn) -> u8 {
        PublishEndcryptEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishEndksgenEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishEndksgenEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishEndksgenEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishEndksgenEn {
    #[inline(always)]
    fn from(val: u8) -> PublishEndksgenEn {
        PublishEndksgenEn::from_bits(val)
    }
}
impl From<PublishEndksgenEn> for u8 {
    #[inline(always)]
    fn from(val: PublishEndksgenEn) -> u8 {
        PublishEndksgenEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeCryptEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeCryptEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeCryptEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeCryptEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeCryptEn {
        SubscribeCryptEn::from_bits(val)
    }
}
impl From<SubscribeCryptEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeCryptEn) -> u8 {
        SubscribeCryptEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeKsgenEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeKsgenEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeKsgenEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeKsgenEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeKsgenEn {
        SubscribeKsgenEn::from_bits(val)
    }
}
impl From<SubscribeKsgenEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeKsgenEn) -> u8 {
        SubscribeKsgenEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeRateoverrideEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeRateoverrideEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeRateoverrideEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeRateoverrideEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeRateoverrideEn {
        SubscribeRateoverrideEn::from_bits(val)
    }
}
impl From<SubscribeRateoverrideEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeRateoverrideEn) -> u8 {
        SubscribeRateoverrideEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
