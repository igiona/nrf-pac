...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct PublishAcquired(pub u32);
impl PublishAcquired {
    #[doc = "DPPI channel that event ACQUIRED will publish to."]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::PublishAcquiredEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::PublishAcquiredEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::PublishAcquiredEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for PublishAcquired {
    #[inline(always)]
    fn default() -> PublishAcquired {
        PublishAcquired(0)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SubscribeAcquire(pub u32);
impl SubscribeAcquire {
    #[doc = "DPPI channel that task ACQUIRE will subscribe to"]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::SubscribeAcquireEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::SubscribeAcquireEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::SubscribeAcquireEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for SubscribeAcquire {
    #[inline(always)]
    fn default() -> SubscribeAcquire {
        SubscribeAcquire(0)
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SubscribeRelease(pub u32);
impl SubscribeRelease {
    #[doc = "DPPI channel that task RELEASE will subscribe to"]
    #[inline(always)]
    pub const fn chidx(&self) -> u8 {
        let val = (self.0 >> 0usize) & 0xff;
        val as u8
    ...
    #[inline(always)]
    pub const fn en(&self) -> super::vals::SubscribeReleaseEn {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::SubscribeReleaseEn::from_bits(val as u8)
    }
    #[inline(always)]
    pub fn set_en(&mut self, val: super::vals::SubscribeReleaseEn) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
impl Default for SubscribeRelease {
    #[inline(always)]
    fn default() -> SubscribeRelease {
        SubscribeRelease(0)
    }
}
