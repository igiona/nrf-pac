...
impl Shorts {
    ...
    #[inline(always)]
    pub const fn compare6_clear(&self) -> bool {
        let val = (self.0 >> 6usize) & 0x01;
        val != 0
    }
    #[doc = "Shortcut between event COMPARE\\[6\\] and task CLEAR"]
    #[inline(always)]
    pub fn set_compare6_clear(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
    }
    #[doc = "Shortcut between event COMPARE\\[7\\] and task CLEAR"]
    #[inline(always)]
    pub const fn compare7_clear(&self) -> bool {
        let val = (self.0 >> 7usize) & 0x01;
        val != 0
    }
    #[doc = "Shortcut between event COMPARE\\[7\\] and task CLEAR"]
    #[inline(always)]
    pub fn set_compare7_clear(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn compare6_stop(&self) -> bool {
        let val = (self.0 >> 22usize) & 0x01;
        val != 0
    }
    #[doc = "Shortcut between event COMPARE\\[6\\] and task STOP"]
    #[inline(always)]
    pub fn set_compare6_stop(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
    }
    #[doc = "Shortcut between event COMPARE\\[7\\] and task STOP"]
    #[inline(always)]
    pub const fn compare7_stop(&self) -> bool {
        let val = (self.0 >> 23usize) & 0x01;
        val != 0
    }
    #[doc = "Shortcut between event COMPARE\\[7\\] and task STOP"]
    #[inline(always)]
    pub fn set_compare7_stop(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
    }
}
