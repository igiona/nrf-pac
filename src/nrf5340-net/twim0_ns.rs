...
impl Twim0ns {
    ...
    pub const fn publish_suspended(
        self,
    ) -> crate::common::Reg<regs::PublishSuspended, crate::common::RW> {
    ...
    pub const fn publish_lastrx(
        self,
    ) -> crate::common::Reg<regs::PublishLastrx, crate::common::RW> {
    ...
    pub const fn publish_lasttx(
        self,
    ) -> crate::common::Reg<regs::PublishLasttx, crate::common::RW> {
