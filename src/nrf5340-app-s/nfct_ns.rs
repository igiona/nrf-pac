...
unsafe impl Send for NfctNs {}
unsafe impl Sync for NfctNs {}
impl NfctNs {
    #[inline(always)]
    pub const unsafe fn from_ptr(ptr: *mut ()) -> Self {
        Self { ptr: ptr as _ }
    ...
    pub const fn subscribe_sense(
        self,
    ) -> crate::common::Reg<regs::SubscribeSense, crate::common::RW> {
    ...
    pub const fn subscribe_enablerxdata(
        self,
    ) -> crate::common::Reg<regs::SubscribeEnablerxdata, crate::common::RW> {
    ...
    pub const fn subscribe_goidle(
        self,
    ) -> crate::common::Reg<regs::SubscribeGoidle, crate::common::RW> {
    ...
    pub const fn subscribe_gosleep(
        self,
    ) -> crate::common::Reg<regs::SubscribeGosleep, crate::common::RW> {
    ...
    pub const fn publish_fielddetected(
        self,
    ) -> crate::common::Reg<regs::PublishFielddetected, crate::common::RW> {
    ...
    pub const fn publish_fieldlost(
        self,
    ) -> crate::common::Reg<regs::PublishFieldlost, crate::common::RW> {
    ...
    pub const fn publish_txframestart(
        self,
    ) -> crate::common::Reg<regs::PublishTxframestart, crate::common::RW> {
    ...
    pub const fn publish_txframeend(
        self,
    ) -> crate::common::Reg<regs::PublishTxframeend, crate::common::RW> {
    ...
    pub const fn publish_rxframestart(
        self,
    ) -> crate::common::Reg<regs::PublishRxframestart, crate::common::RW> {
    ...
    pub const fn publish_rxframeend(
        self,
    ) -> crate::common::Reg<regs::PublishRxframeend, crate::common::RW> {
    ...
    pub const fn publish_rxerror(
        self,
    ) -> crate::common::Reg<regs::PublishRxerror, crate::common::RW> {
    ...
    pub const fn publish_autocolresstarted(
        self,
    ) -> crate::common::Reg<regs::PublishAutocolresstarted, crate::common::RW> {
    ...
    pub const fn publish_collision(
        self,
    ) -> crate::common::Reg<regs::PublishCollision, crate::common::RW> {
    ...
    pub const fn publish_selected(
        self,
    ) -> crate::common::Reg<regs::PublishSelected, crate::common::RW> {
