...
impl PublishCrossEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishCrossEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishCrossEn {
    #[inline(always)]
    fn from(val: u8) -> PublishCrossEn {
        PublishCrossEn::from_bits(val)
    }
}
impl From<PublishCrossEn> for u8 {
    #[inline(always)]
    fn from(val: PublishCrossEn) -> u8 {
        PublishCrossEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishDownEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
...
impl PublishDownEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishDownEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishDownEn {
    #[inline(always)]
    fn from(val: u8) -> PublishDownEn {
        PublishDownEn::from_bits(val)
    }
}
impl From<PublishDownEn> for u8 {
    #[inline(always)]
    fn from(val: PublishDownEn) -> u8 {
        PublishDownEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
impl PublishUpEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishUpEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishUpEn {
    #[inline(always)]
    fn from(val: u8) -> PublishUpEn {
        PublishUpEn::from_bits(val)
    }
}
impl From<PublishUpEn> for u8 {
    #[inline(always)]
    fn from(val: PublishUpEn) -> u8 {
        PublishUpEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
