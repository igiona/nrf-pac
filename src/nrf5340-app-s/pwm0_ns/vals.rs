...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishLoopsdoneEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishLoopsdoneEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishLoopsdoneEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishLoopsdoneEn {
    #[inline(always)]
    fn from(val: u8) -> PublishLoopsdoneEn {
        PublishLoopsdoneEn::from_bits(val)
    }
}
impl From<PublishLoopsdoneEn> for u8 {
    #[inline(always)]
    fn from(val: PublishLoopsdoneEn) -> u8 {
        PublishLoopsdoneEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishPwmperiodendEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishPwmperiodendEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishPwmperiodendEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishPwmperiodendEn {
    #[inline(always)]
    fn from(val: u8) -> PublishPwmperiodendEn {
        PublishPwmperiodendEn::from_bits(val)
    }
}
impl From<PublishPwmperiodendEn> for u8 {
    #[inline(always)]
    fn from(val: PublishPwmperiodendEn) -> u8 {
        PublishPwmperiodendEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishSeqendEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishSeqendEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishSeqendEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishSeqendEn {
    #[inline(always)]
    fn from(val: u8) -> PublishSeqendEn {
        PublishSeqendEn::from_bits(val)
    }
}
impl From<PublishSeqendEn> for u8 {
    #[inline(always)]
    fn from(val: PublishSeqendEn) -> u8 {
        PublishSeqendEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum PublishSeqstartedEn {
    #[doc = "Disable publishing"]
    DISABLED = 0x0,
    #[doc = "Enable publishing"]
    ENABLED = 0x01,
}
impl PublishSeqstartedEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> PublishSeqstartedEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for PublishSeqstartedEn {
    #[inline(always)]
    fn from(val: u8) -> PublishSeqstartedEn {
        PublishSeqstartedEn::from_bits(val)
    }
}
impl From<PublishSeqstartedEn> for u8 {
    #[inline(always)]
    fn from(val: PublishSeqstartedEn) -> u8 {
        PublishSeqstartedEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
...
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeNextstepEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeNextstepEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeNextstepEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeNextstepEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeNextstepEn {
        SubscribeNextstepEn::from_bits(val)
    }
}
impl From<SubscribeNextstepEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeNextstepEn) -> u8 {
        SubscribeNextstepEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub enum SubscribeSeqstartEn {
    #[doc = "Disable subscription"]
    DISABLED = 0x0,
    #[doc = "Enable subscription"]
    ENABLED = 0x01,
}
impl SubscribeSeqstartEn {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SubscribeSeqstartEn {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SubscribeSeqstartEn {
    #[inline(always)]
    fn from(val: u8) -> SubscribeSeqstartEn {
        SubscribeSeqstartEn::from_bits(val)
    }
}
impl From<SubscribeSeqstartEn> for u8 {
    #[inline(always)]
    fn from(val: SubscribeSeqstartEn) -> u8 {
        SubscribeSeqstartEn::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
